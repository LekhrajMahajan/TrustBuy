...
const LoginPage = () => {
  ...
  // Google popup login — sends access_token to our backend
  const handleGoogleLogin = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      ...
      if (result.success) {
        ...
        toast.error("Google Login Failed", { description: result.message });
      }
    },
    onError: () => {
      toast.error("Google Login Failed", { description: "Authentication was cancelled or failed." });
    },
    flow: 'implicit',
  });
